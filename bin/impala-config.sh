...
#export IMPALA_HADOOP_VERSION=1.0.3-mapr-2.1.2.1
export IMPALA_HADOOP_VERSION=0.20.2-mapr2.1.2
export IMPALA_HIVE_VERSION=0.10.0-mapr-SNAPSHOT
export IMPALA_HBASE_VERSION=0.94.5-mapr
export IMPALA_THRIFT_VERSION=0.9.0
export IMPALA_AVRO_VERSION=1.7.1
